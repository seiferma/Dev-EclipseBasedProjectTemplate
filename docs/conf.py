...
# -*- coding: utf-8 -*-
#
# Dev-EclipseBasedProjectTemplate documentation build configuration file, created by
...
htmlhelp_basename = 'Dev-EclipseBasedProjectTemplatedoc'
...
man_pages = [
    (master_doc, 'dev-eclipsebasedprojecttemplate', 'Dev-EclipseBasedProjectTemplate Documentation',
     [author], 1)
]
